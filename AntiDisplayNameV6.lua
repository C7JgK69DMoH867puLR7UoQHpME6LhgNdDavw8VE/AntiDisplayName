local AntiDisplayName = loadstring(game:HttpGet('https://raw.githubusercontent.com/C7JgK69DMoH867puLR7UoQHpME6LhgNdDavw8VE/AntiDisplayName/main/AntiDisplayName.lua'))(function()
    getgenv().Preferences = {}
end)
